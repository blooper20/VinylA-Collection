...
const genres = [
  ...
  { title: '힙합',          sub: 'Hip Hop',     height: 300, img: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?q=80&w=800&auto=format&fit=crop' },
  { title: 'R&B / 소울',    sub: 'R&B / Soul',  height: 360, img: 'https://images.unsplash.com/photo-1478146896981-b80fe463b330?q=80&w=800&auto=format&fit=crop' },
  { title: '인디 / 포크',   sub: 'Folk',        height: 280, img: 'https://images.unsplash.com/photo-1458560871784-56d23406c091?q=80&w=800&auto=format&fit=crop' },
  ...
  { title: '레게',          sub: 'Reggae',      height: 300, img: 'https://images.unsplash.com/photo-1518655048521-f130df041f66?q=80&w=800&auto=format&fit=crop' },
