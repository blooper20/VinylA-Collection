...
export const DetailModal: React.FC<DetailModalProps> = ({ album, onClose, coverCandidates }) => {
  ...
  React.useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [album.ALBUM_ID, album.ARTIST, album.TITLE, album.IMAGE_URL, album.SOURCE, album.COMMUNITY_TRACKS, album.SUBMITTED_BY, user?.id, releaseId, customPressingId]);
        ...
        <div className={styles.rightPanel}>
          ...
          <div className={styles.tracklistContainer}>
            <div className={styles.tracklistHeader} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
              ...
              {album.SOURCE && album.SOURCE !== 'DISCOGS' && user?.id === album.SUBMITTED_BY && !communityLocked && (
                <Link
                  href={`/community-albums/${album.ALBUM_ID}/edit`}
                  style={{ color: 'inherit', opacity: 0.6, fontSize: '0.8rem', textDecoration: 'underline' }}
                >
